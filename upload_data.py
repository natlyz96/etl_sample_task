...
def simple_validation(engine, file_name_athlets, file_name_regions, table_name_w, table_name_s, table_name_r):
    ...
    print(f"CSV file {file_name_regions} contains {input_regions_rows}.")
    print(f"Uploaded to postgres {output_regions_rows} rows.")
    print(f"CSV file {file_name_athlets} contains {input_athlets_rows}.")
    print(
...
if __name__ == '__main__':
    ...
    table_name_r = "nations_and_regions"
    ...
    try:
        ...
        upload_to_pg(engine, FILE_NAME_athlets, FILE_NAME_regions, table_name_w, table_name_s, table_name_r)

        simple_validation(engine, FILE_NAME_athlets, FILE_NAME_regions, table_name_w, table_name_s, table_name_r)
    except:
